...
- ホログラム、ポップ3D、前景微振動、Depth多層は複数同時に適用でき、それぞれ異なる強度を設定できます。
- 設定表示中は人物／物体マスク、キャラ範囲、光源Rayを重ね、キャラ中心と光源を画像上でドラッグできます。
- 人物自動分離または任意マスクの輪郭で非破壊に切り抜き、境界ぼかし、Undo／Redoを利用できます。
